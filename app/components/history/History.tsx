          ...
          <div className="w-full">
            ...
            {debug && (
              <p className="text-xs text-muted-foreground/60 mt-0.5">
                Les messages avec le badge <span className="font-mono text-flame/80">Debug</span> sont des notes
                internes, ils seront ignorés dans la conversation avec Moko une fois le mode debug désactivé.
              </p>
            )}
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-2 py-2 scrollbar-none will-change-scroll">
          {filteredMessages.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-sm text-muted-foreground/60">Commence à discuter avec Moko</p>
            </div>
          ) : (
...
// TODO : FIX TOOLBAR RESPONSIVENESS (BUG: when opening history on mobile, toolbar is misplaced)
